...
class ScoringService(object):
    ...
    def train_and_save_model(
        ...
        for label in labels:
            print(label)
            train_X, train_y, val_X, val_y = utility.create_train_val(
                cls.dfs, codes, label)
    ...
    def predict(cls, inputs, labels=None, codes=None,
        ...
        buff = []
        for code in codes:
            buff.append(utility.get_features_for_predict(
                cls.dfs, code, start_dt))
